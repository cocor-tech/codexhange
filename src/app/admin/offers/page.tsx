...
export default function OffersPage() {
  ...
  useEffect(() => { load(page); }, [page, filter, typeFilter]);
      ...
      <div className="mx-auto max-w-7xl px-6 py-6">
        ...
        {loading ? <p className="text-xs" style={{ color: 'var(--text-muted)' }}>Loading...</p> : (
          <div className="space-y-2">
            ...
            {offers.length === 0 && <p className="text-xs text-center py-8" style={{ color: 'var(--text-muted)' }}>No offers yet. Add a website and run a scan.</p>}
          </div>
        )}
