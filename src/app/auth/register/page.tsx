...
export default function RegisterPage() {
  ...
  return (
    <div className="space-y-4">
      <Button onClick={handleGoogle} loading={loading} variant="glass" className="w-full justify-center">
      ...
      <p className="text-center text-xs" style={{ color: 'var(--text-muted)' }}>
        ...
        <a href="/docs#terms" className="underline hover:text-[--text-primary]">Terms</a> and{' '}
        <a href="/docs#privacy" className="underline hover:text-[--text-primary]">Privacy Policy</a>.
      </p>
    </div>
  );
}
